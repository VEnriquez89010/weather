...
var Routes = [
    ...
    {
        path: 'hermosillo', component: __WEBPACK_IMPORTED_MODULE_3__dashboard_dashboard_component__["a" /* DashboardComponent */]
    },
    {
        path: 'obregon', component: __WEBPACK_IMPORTED_MODULE_3__dashboard_dashboard_component__["a" /* DashboardComponent */]
    },
    {
        path: 'nogales', component: __WEBPACK_IMPORTED_MODULE_3__dashboard_dashboard_component__["a" /* DashboardComponent */]
    },
    {
        path: 'navojoa', component: __WEBPACK_IMPORTED_MODULE_3__dashboard_dashboard_component__["a" /* DashboardComponent */]
    }
];
...
var DashboardService = (function () {
    ...
    */
    DashboardService.prototype.getObregon = function () {
        return this.http.get('/obregon/').map(function (result) {
            return result;
        });
    };
    /*
    ...
    */
    DashboardService.prototype.getHillo = function () {
        return this.http.get('/hermosillo/').map(function (result) {
            return result;
        });
    };
    /*
    ...
    */
    DashboardService.prototype.getNavo = function () {
        return this.http.get('/navojoa/').map(function (result) {
            return result;
        });
    };
    /*
    ...
    */
    DashboardService.prototype.getNogal = function () {
        return this.http.get('/nogales/').map(function (result) {
            return result;
        });
    };
...
module.exports = "\n <!--<input type=\"date\" (change)=\"onDateSelected($event.target.value)\">-->\n\n<div class=\"container\" id=\"mainDiv\">\n  <div class=\"row\" style=\"background-color:lightblue;\">\n  <!--Title-->\n  <div class=\"col-md-12 col-lg-12 col-lg-12 text-center\" style=\"padding-bottom: 50px;\">\n    <h1>Weather Dashboard  <img src=\"../assets/wather.png\" height=\"70\" width=\"70\"/></h1>\n    <h6><span>{{ currentDate }}</span></h6>\n  </div>\n      <div class=\"col-md-9 col-lg-9 col-lg-9\" style=\"opacity: 0.9;\">\n        <hr>\n        <h2>{{ currentCity }}</h2>\n        <h3>Today's temp is: {{ currentTemp }} °{{ tempSelector }} </h3>\n        <hr>\n        <div *ngIf=\"chart\">\n          <canvas id=\"canvas\">{{ chart }}</canvas>\n        </div>\n        <hr>\n      </div>\n      <div class=\"col-xs-6 col-sm-3 col-md-3 col-small-high-bloc no-padding-horizontal\">\n        <div class=\"col-xs-6 col-md-3 col-small-bloc no-padding-horizontal\">\n          <div class=\"col-xs-6 bloc-parent bloc-small-parent\">\n            <div class=\"bloc-small bloc anthracite\">\n              <span>City</span> <br/>\n              <select class=\"form-control-sm\" (change)=\"onCitySelected($event.target.value)\">\n                <option value=\"Obregon\">Cd. Obregon</option>\n                <option value=\"Navojoa\">Navojoa</option>\n                <option value=\"Hermosillo\">Hermosillo</option>\n                <option value=\"Nogales\">Nogales</option>\n              </select>\n            </div>\n          </div>\n          <div class=\"col-xs-6 bloc-parent bloc-small-parent\">\n            <div class=\"bloc-small bloc brick\">\n              <br/><span>Scale</span><br/>\n              <select class=\"form-control-sm\" (change)=\"onTemperatureSelected($event.target.value)\">\n                <option value=\"C\">Celsius</option>\n                <option value=\"F\">Fahrenheit</option>\n              </select>\n            </div>\n          </div>\n        </div>\n        <div class=\"col-xs-12 col-md-6 bloc-parent bloc-high-parent\">\n          <div class=\"bloc-high bloc indigo\">\n            <br/><br/>\n            <div class=\"table-wrapper\">\n              <table class=\"table table-striped\">\n                <thead class=\"thead-dark\">\n                <tr>\n                  <th>Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>\n                  <th>Temperature</th>\n                </tr>\n                </thead>\n                <tbody>\n                <tr *ngFor=\"let dash of dashboard\">\n                  <td>{{ dash.datetime }}</td>\n                  <td>{{ dash.temp }}°</td>\n                </tr>\n                </tbody>\n              </table>\n            </div>\n\n          </div>\n        </div>\n      </div>\n  </div>\n  </div>\n\n\n"
...
var DashboardComponent = (function () {
    ...
    */
    DashboardComponent.prototype.onCitySelected = function (val) {
        var _this = this;
        switch (val) {
            case 'Obregon':
                this.dashboardService.getObregon().subscribe(function (result) {
                ...
                break;
            case 'Hermosillo':
                this.dashboardService.getHillo().subscribe(function (result) {
                    _this.updateDashboard(result, 'Hermosillo');
                });
                break;
            case 'Navojoa':
                this.dashboardService.getNavo().subscribe(function (result) {
                    _this.updateDashboard(result, 'Navojoa');
                });
                break;
            case 'Nogales':
                this.dashboardService.getNogal().subscribe(function (result) {
                    _this.updateDashboard(result, 'Nogales');
                });
                break;
        }
    };
     ...
     */
    DashboardComponent.prototype.updateDashboard = function (dashboard, city) {
     ...
     */
    DashboardComponent.prototype.validateScale = function (dashboard) {
     ...
     */
    DashboardComponent.prototype.onTemperatureSelected = function (val) {
        switch (val) {
            case 'C':
     ...
     */
    DashboardComponent.prototype.createChart = function (dashboard) {
        var weatherDates = [];
        var dataMin = [];
        var dataMax = [];
     ...
     */
    DashboardComponent.prototype.converFahrenheit = function (dash) {
     ...
     */
    DashboardComponent.prototype.converCelsius = function (dash) {
        JSON.parse(JSON.stringify(dash)).forEach(function (value, key) {
...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-inverse fixed-top\">\n  <img src=\"../../assets/navicon.png\" height=\"50\" width=\"50\"/>\n  <div class=\"collapse navbar-collapse\">\n       <strong>Victor Hugo Enriquez Gonzalez</strong>\n  </div>\n</nav>\n"
